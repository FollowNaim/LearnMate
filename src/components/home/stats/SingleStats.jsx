...
function SingleStats(props) {
  ...
  return (
    ...
    >
      <Card className="dark:bg-transparent border-border shadow-sm hover:border hover:border-red-600 hover:duration-300 hover:ease-in-out hover:-translate-y-1 min-h-32 dark:text-black">
        <CardHeader className="flex flex-col lg:flex-row gap-6 lg:items-center">
          ...
          <div className="flex flex-col">
            <h5 className="text-lg font-semibold">{count || 0}</h5>
